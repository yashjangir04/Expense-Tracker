        ...
        <table className="w-full border-collapse">
          <thead className="bg-zinc-700 text-left text-zinc-200">
            <tr>
              ...
              <th className="p-4 border-b border-zinc-600 text-center" colSpan="2">
                Actions
              </th>
            </tr>
          </thead>
          <tbody>
            {approvals.map((item) => (
              <React.Fragment key={item._id}>
                ...
                >
                  <td className="p-4 border-b border-zinc-700">{item.createdAt.substr(0 , 10)}</td>
                  <td className="p-4 border-b border-zinc-700">{item.userId?.userName}</td>
                  <td className="p-4 border-b border-zinc-700">{item.category}</td>
                  <td
